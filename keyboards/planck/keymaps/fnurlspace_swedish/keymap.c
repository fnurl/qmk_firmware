...
[_PLEFT_SE] = KB_LAYOUT_LAYER(
   ...
   ______ , XXXXXX , SE_LABK, SE_LCBR, SE_LPRN, SE_LBRC ,  SE_ASTR, SE_DLR , SE_EQL , SE_AMPR, SE_PERC, SE_ACUT_DEAD,\
   ______ , XXXXXX , XXXXXX , SE_UNDS, SE_MINS, SE_COLN ,  SE_SCLN, SE_DQUO, SE_QUOT, SE_PIPE, SE_BSLS, SE_DIAE_DEAD,\
